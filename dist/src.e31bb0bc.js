...
exports.TittleBlock = exports.TextBlock = exports.ImageBlock = exports.ColumnsBlock = exports.Block = void 0;
...
var TittleBlock = /*#__PURE__*/function (_Block) {
  _inherits(TittleBlock, _Block);

  var _super = _createSuper(TittleBlock);

  function TittleBlock(value, options) {
    _classCallCheck(this, TittleBlock);

    return _super.call(this, value, options);
  }

  _createClass(TittleBlock, [{
    key: "toHTML",
    value: function toHTML() {
...
exports.TittleBlock = TittleBlock;
...
var model = [new _blocks.TittleBlock('Конструктор сайтов на чистом JavaScript', {
  tag: 'h2',
  styles: {
...
var Sidebar = /*#__PURE__*/function () {
  ...
  _createClass(Sidebar, [{
    ...
    key: "template",
    get: function get() {
      return [(0, _utils.block)('text'), (0, _utils.block)('tittle')].join('');
    }
  }, {
    key: "add",
...
var updateCallback = function updateCallback(newBlock) {
  _model.model.push(newBlock), site.render(_model.model);
};

var sidebar = new _sidebar.Sidebar('#panel', updateCallback);
